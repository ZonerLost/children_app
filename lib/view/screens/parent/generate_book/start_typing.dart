...
class StartTyping extends StatefulWidget {
  const StartTyping({super.key});

  @override
  State<StartTyping> createState() => _StartTypingState();
}

class _StartTypingState extends State<StartTyping> {
    ...
    return CustomContainer(
      child: Scaffold(
              ...
              CustomCard2(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: MyTextField(hintText: 'Chapter name')),
                        SizedBox(width: 8),
                        Expanded(
                          child: MyTextField(hintText: 'Chapter number'),
                        ),
                      ],
                    ),
                    Column(
              ...
              Center(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset(Assets.imagesMic, height: 14),
                      Container(height: 14, width: 1, color: kBorderColor),
                      Image.asset(Assets.imagesPara, height: 16),
                      Container(height: 14, width: 1, color: kBorderColor),
                      Image.asset(Assets.imagesPaint, height: 14),
                    ],
                  ),
                ),
              ),
        ...
        bottomNavigationBar: Padding(
          ...
          child: MyButton(
            buttonText: showPreview ? 'Back' : 'Preview my book',
            onTap: onPreviewTap,
